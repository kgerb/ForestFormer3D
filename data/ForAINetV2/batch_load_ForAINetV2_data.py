...
def export_one_scan(
    scan_name, output_filename_prefix, max_num_point, forainetv2_dir, test_mode=True
):
    ...
    (
        ...
        axis_align_matrix,
        offsets,
    ) = export(ply_file, None, test_mode)
...
def batch_export(
    max_num_point, output_folder, scan_names_file, forainetv2_dir, test_mode=True
):
